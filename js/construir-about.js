...
function construirAbout(querido){
  document.getElementById('descripcion').innerHTML+=`  <img class="mx-auto d-block img-fluid"  style="max-width:290px; border-top:15px solid transparent" src=${querido[0].portada} alt="logo ${querido[0].nombre}"  >
